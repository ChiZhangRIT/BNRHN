...
import show_and_tell_model_bnrhn
...
def run_once(model, saver, summary_writer, summary_op):
  ...
  # model_path = '/cis/phd/cxz2081/im2txt/im2txt/model/train_bnrhn/model.ckpt-186803'
  if not model_path:
...
def run():
  ...
  with g.as_default():
    ...
    model_config = configuration.BNRHNModelConfig()
    model_config.input_file_pattern = FLAGS.input_file_pattern
    model = show_and_tell_model_bnrhn.ShowAndTellModel_BNRHN(model_config, mode="eval")
    model.build()
